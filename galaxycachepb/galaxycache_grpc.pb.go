...
func (c *galaxyCacheClient) GetFromPeer(ctx context.Context, in *GetRequest, opts ...grpc.CallOption) (*GetResponse, error) {
	...
	out := new(GetResponse)
	err := c.cc.Invoke(ctx, GalaxyCache_GetFromPeer_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
// UnimplementedGalaxyCacheServer must be embedded to have
...
func RegisterGalaxyCacheServer(s grpc.ServiceRegistrar, srv GalaxyCacheServer) {
	// If the following call pancis, it indicates UnimplementedGalaxyCacheServer was
